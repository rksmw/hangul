...
#define GOSSIP_START_EVENT2     "Estoy listo para el proximo desafio."
#define GOSSIP_START_EVENT_SKIP "Estoy listo. Sin embargo me gustaria saltar la presentacion."
